...
export default function HeaderAuth() {
    ...
    return (
      <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3">
        ...
        <button
          ...
          className="text-xs sm:text-sm py-1.5 px-3 lg:py-2 lg:px-4 rounded-xl font-semibold border border-[#E5E5E5] dark:border-white/20 text-[#1F2A44] dark:text-[#FAF4EF] hover:bg-[#FFB957]/10 transition-colors whitespace-nowrap"
          aria-label="Sign out"
        >
  ...
  return (
    <>
      ...
      <a
        href="/register"
        className="btn-gold text-xs sm:text-sm py-1.5 px-3 lg:py-2 lg:px-4 whitespace-nowrap"
        title="Get Started"
      >
